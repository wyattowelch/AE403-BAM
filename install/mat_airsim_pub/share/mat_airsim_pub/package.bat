...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\mat_airsim_pub\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/mat_airsim_pub/local_setup.bat"
