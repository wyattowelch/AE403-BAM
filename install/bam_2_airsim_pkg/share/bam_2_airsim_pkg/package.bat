...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\bam_2_airsim_pkg\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/bam_2_airsim_pkg/local_setup.bat"
