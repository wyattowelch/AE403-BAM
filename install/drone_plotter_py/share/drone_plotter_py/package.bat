...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\drone_plotter_py\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\drone_plotter_py\hook\ament_prefix_path.bat"
