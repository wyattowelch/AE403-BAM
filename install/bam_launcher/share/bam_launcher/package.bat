...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\bam_launcher\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\bam_launcher\hook\ament_prefix_path.bat"
