...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\mat_airsim_pub_nonlib\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/mat_airsim_pub_nonlib/local_setup.bat"
