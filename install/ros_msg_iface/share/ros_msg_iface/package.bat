...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros_msg_iface\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/ros_msg_iface/local_setup.bat"
