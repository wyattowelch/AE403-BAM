...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\phase_space_warping_py\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\phase_space_warping_py\hook\ament_prefix_path.bat"
