...
set "AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub] "%AMENT_CURRENT_PREFIX%\share\mat_airsim_pub\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub] "%AMENT_CURRENT_PREFIX%\share\mat_airsim_pub\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub]:;=";"%") do (
    call:call_file %%f
  )
