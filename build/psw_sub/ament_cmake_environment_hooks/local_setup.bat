...
set "AMENT_ENVIRONMENT_HOOKS[psw_sub]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[psw_sub] "%AMENT_CURRENT_PREFIX%\share\psw_sub\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[psw_sub] "%AMENT_CURRENT_PREFIX%\share\psw_sub\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[psw_sub]:;=";"%") do (
    call:call_file %%f
  )
