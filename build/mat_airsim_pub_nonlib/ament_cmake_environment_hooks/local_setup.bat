...
set "AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub_nonlib]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub_nonlib] "%AMENT_CURRENT_PREFIX%\share\mat_airsim_pub_nonlib\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub_nonlib] "%AMENT_CURRENT_PREFIX%\share\mat_airsim_pub_nonlib\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[mat_airsim_pub_nonlib]:;=";"%") do (
    call:call_file %%f
  )
