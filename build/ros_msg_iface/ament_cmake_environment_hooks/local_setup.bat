...
set "AMENT_ENVIRONMENT_HOOKS[ros_msg_iface]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros_msg_iface] "%AMENT_CURRENT_PREFIX%\share\ros_msg_iface\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros_msg_iface] "%AMENT_CURRENT_PREFIX%\share\ros_msg_iface\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros_msg_iface]:;=";"%") do (
    call:call_file %%f
  )
